...
echo <<<_END
	...
	<p>The site doesn&rsquo;t ask much of you&mdash;not even your real name. Just enter a username, password, and an e-mail address. All information is encrypted and sent over SSL. I can&rsquo;t see your password&mdash;it&rsquo;s encrypted. Remember to make a note of it.</p>

	<p align="center"><img src="/images/signup.jpg" style="width:80%; border:0;"></p>

	<p>The e-mail address is to verify you and for password recovery, should you need it. I promise never to spam you or share your address. (Feel free to contact me back at heytherecongress@gmail.com.)</p>

	<p>After submitting your username and password, you&rsquo;ll get a confirmation e-mail. Click the link in that e-mail, log in with your new credentials, and you&rsquo;re looking at the main page. In fact, this site has only two pages (not counting this tutorial): the main page and the &ldquo;add a group&rdquo; page. Let&rsquo;s start with the main page.</p>
