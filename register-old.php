...
<div id="welcome_stranger">
	...
	<div id="this_is_better">
		...
		<h3>This is an unattractive but simple website that does one thing: pinpoint members of Congress who meet chosen criteria. (<a class="tutolink" onclick="tutorial()">Here&rsquo;s a quick tutorial.</a>) To work properly, it requires that you create a unique identity. (It&rsquo;s free, I don&rsquo;t ask for your real name, and I&rsquo;ll only use your email address for verification or password issues.)<br><br></h3>
	...
	<div id="quick_login">
		...
		<a onclick='reset()'>Forgot your Password?</a><br>
...
<div id="registry_form" class="row">
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		...
		<div class="form-group">
			<input type="email" name="email" id="email" class="form-control input-lg" placeholder="Email Address" value="<?php if(isset($error)){ echo $_POST['email']; } ?>" tabindex="40">
		</div>
		<div class="row">
